        {foreach from=$CaseInfo.ActionList key=StepNum item=ActionInfo}
        <dl style="text-align:left;margin:6px 3px;padding:0;">
          ...
          <dd style="float:left;clear:both;width:95%;clear:both;background-color:#F0F0F0;border:1px solid #E4E4E4;margin:0 0 0 4px;padding:5px;">
            <ul style="list-style:none;margin:0;padding:0;color:#333333;">
              {foreach from=$ActionInfo.HistoryList key=Key item=HistoryInfo}
              {if $HistoryInfo.ActionField eq 'CaseSteps' or $HistoryInfo.ActionField eq 'CaseTitle'}
