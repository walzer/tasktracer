    ...
    <table width="100%" align="center" border=0 id="CustomSetTable" cellpadding="1" cellspacing="1" class="BgTable">
      ...
      <tr>
        <td colspan="5" align="center" style="padding:10px 0 6px">
          <input type="submit" value="{$Lang.FieldsToShowBTN}" class="ActionButton" accesskey="O">
          <input type="button" value="{$Lang.FieldsDefaultBTN}" class="ActionButton" onclick="setDefaultFields(xajax.$('FieldsToShowList'))" accesskey="D" /><br />
        </td>
      </tr>
    </table>
    </div>
