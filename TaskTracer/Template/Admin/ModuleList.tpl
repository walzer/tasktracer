...
{include file="Admin/AdminTopNav.tpl"}
  ...
  {if $ModuleID > 0}
    ...
    <dl>
      ...
      <input type="submit" id="SaveModuleSubmit" name="SaveModuleSubmit" value="{$Lang.SaveModule}" />
      <input type="submit" name="DeleteModuleSbumit" value="{$Lang.DeleteModule}" onclick="{literal}if(confirm('{/literal}{$Lang.ConfirmDeleteModule}{literal}')){xajax.$('DeleteModule').value=1;return true;}else{return false;}{/literal}"/>
    ...
    <dl>
      ...
      <input type="hidden" name="ModuleID" value="{$ModuleID}" />
      <input type="hidden" name="ModuleType" value="{$ModuleType}" />
      <input type="submit" id="SaveModuleSubmit" name="SaveModuleSubmit" value="{$Lang.Save}" />
      <input type="hidden" id="DeleteModule" name="DeleteModule" value="0" />
    </dl>{/if}
  </div>
  </form>
  ...
  <div id="AMForm" class="CommonForm AdminForm" style="width:500px;float:left;margin-top:20px">
    ...
    <dl>
      ...
      <input type="hidden" name="ModuleType" value="{$ModuleType}" />
      <input type="submit" name="SaveProject" value="{$Lang.AddModule}" />
    </dl>
  </div>
