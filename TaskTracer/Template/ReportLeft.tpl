...
<div id="ReportTypeDiv" class="CommonDiv" style="text-align:left;margin-top:3px;width:210px;">
...
<br />
<center>
<input type="Submit" name="ReportSubmit" value="{$Lang.ViewReportBTN}" />
<input type="button" value="{$Lang.SelectAllBTN}" onclick="selectAllCheckbox('ReportTypeDiv');" />
<input type="button" value="{$Lang.SelectNoneBTN}" onclick="selectAllCheckbox('ReportTypeDiv',false);" />
</center>
</div>
</form>
