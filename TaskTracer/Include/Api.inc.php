...
function apiEditItem($ItemType, $FieldsValue, $RawItemInfo)
{
    ...
    {
        if(in_array($FieldName, array('BugTitle', 'ReproSteps', 'CaseTitle', 'CaseSteps', 'ResultSteps')))
        {
    ...
    $RawItemInfo['TestUserName'] = $_SESSION['TestUserName'];
...
function apiAddItem($ItemType, $FieldsValue)
{
    ...
    $ItemInfo['TestUserName'] = $_SESSION['TestUserName'];
