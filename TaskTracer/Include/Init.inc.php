...
if(!file_exists($_CFG['RealRootPath'] . '/Include/Config.inc.php'))
{
    die("
        ...
        <pre>
        You can manually copy a new Include/Config.inc.php from Include/Config.Default.php.
        </pre>
");
}
...
if(!preg_match('/(Login.php|install|api)/i', $_SERVER['PHP_SELF']) &&  $_CFG['BrowserMode'])
{
    baseJudgeUserLogin();
...
if(preg_match('/Login.php/i', $_SERVER['PHP_SELF']) && $_SESSION['LoginJumpURI'] == '')
{
