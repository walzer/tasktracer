...
CREATE TABLE `BugInfo` (
  ...
  `IsDroped` enum('1','0') NOT NULL default '0',
	`BugScore` TINYINT NOT NULL DEFAULT '1',
	`FixQuality` FLOAT NOT NULL DEFAULT '1',
	`BugAffairStr` VARCHAR( 100 ) DEFAULT NULL ,
	`UnlistedScore` TINYINT UNSIGNED NULL DEFAULT '0',
	`Deadline` DATETIME NULL DEFAULT '0000-00-00 00:00:00',
	`DeadlineStatus` VARCHAR( 20 ) DEFAULT NULL,
  PRIMARY KEY  (`BugID`),
  ...
  KEY `BugScore` (`BugScore`),
  KEY `DeadlineStatus` (`DeadlineStatus`)
...
CREATE TABLE `CaseInfo` (
  ...
  `IsDroped` enum('1','0') NOT NULL default '0',
  `ScoreResolved` INT NOT NULL DEFAULT '0',
  `ScoreUnresolved` INT NOT NULL DEFAULT '0',
  ...
  KEY `ScoreUnresolved` (`ScoreResolved`),
  KEY `ScoreTotal` (`ScoreTotal`),
  KEY `ResolvedPercent` (`ResolvedPercent`)
) TYPE=MyISAM $CharSetCollate;
CREATE TABLE `AffairList` (
	`AffairID` INT(11) UNSIGNED NOT NULL AUTO_INCREMENT,
	`ProjectID` MEDIUMINT(8) NOT NULL DEFAULT '0',
	`ModuleID` MEDIUMINT(8) NOT NULL DEFAULT '0',
	`AffairParent` INT(11) UNSIGNED NOT NULL DEFAULT '0',
	`AffairName` VARCHAR( 100 ) DEFAULT NULL ,
	`Manhour` TINYINT(4) NOT NULL DEFAULT '0',
  PRIMARY KEY (`AffairID`),
  KEY `AffairName` (`AffairName`),
  KEY `ProjectID` (`ProjectID`),
  KEY `ModuleID` (`ModuleID`)
) TYPE=MyISAM $CharSetCollate;
CREATE TABLE `AffairManhour` (
	`id` int(11) unsigned NOT NULL auto_increment,
	`AffairID` varchar(100) DEFAULT NULL,
	`Scope` smallint(1) NOT NULL,
	`Complexity` char(1) NOT NULL,
	`Manhour` smallint(1) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `AffairID` (`AffairID`),
  KEY `Scope` (`Scope`),
  KEY `Complexity` (`Complexity`)
) TYPE=MyISAM $CharSetCollate;
CREATE TABLE `AffairQuotiety` (
	`id` int(11) NOT NULL auto_increment,
	`Scope` smallint(1) NULL,
	`Complexity` char(1) NULL,
