...
{/literal}
  <div id="LeftUserControl" class="TabContainer" style="margin-bottom:0;border-bottom-width:0;">
    ...
    <h2 id="UCTitle3" class="Tab {$TestMode}Mode" style="border:0;padding:0 2px;"><a href="javascript:void(0);" onclick="xajax_xUpdateUserControl('{$TestMode}');return false;"><img src="Image/icon_refresh.gif" /></a></h2>
   {if $TestMode == 'Bug'}
