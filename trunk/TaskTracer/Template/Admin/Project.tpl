...
{include file="Admin/AdminTopNav.tpl"}
  ...
  <form id="ProjectForm" action="" method="post" onsubmit="xajax_xAdmin{$ActionType}(xajax.getFormValues('ProjectForm'));return false;">
  <div id="PForm" class="CommonForm AdminForm">
    ...
    <dl class="Line"></dl>
    <dl>
      <input type="submit" name="SaveProject" value="{$Lang.SaveProject}" />
